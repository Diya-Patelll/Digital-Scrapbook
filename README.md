...
2. Open Scrapbook.xcodeproj in Xcode 15.0+
3. Connect your iPhone via USB or select an iPhone Simulator from the top toolbar in Xcode
4. Build and Run (Cmd + R)

<h2>How to use app</h2>

- Tap the + icon on the main screen to start a page
